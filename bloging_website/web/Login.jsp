<%-- 
    Document   : Login
    Created on : Oct 29, 2023, 7:33:59 PM
    Author     : RAHUL
--%>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <div class="card " style="border-style: dotted; border-width:2px;border-color:blue " >
                            <div class="card-header text-center" style="background:red; color:aliceblue ">
